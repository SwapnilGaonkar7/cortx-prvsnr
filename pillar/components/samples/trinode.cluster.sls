...
cluster:
  ...
  type: 3_node                          # single/dual/generic/3_node
  node_list:
    - srvnode-1
    - srvnode-2
	- srvnode-3
  ...
  srvnode-2:
    ...
    network:
      ...
      data_nw:                        # Data network interfaces
        ...
        roaming_ip: 192.168.0.5       # Applies to private data network
    storage:
      metadata_device:                # Device for /var/motr and possibly SWAP
        - /dev/sdb                    # Auto-populated by components.system.storage.multipath
      data_devices:                   # Data device/LUN from storage enclosure
  ...
  srvnode-3:
    ...
    network:
      ...
      data_nw:                        # Data network interfaces
        ...
        netmask: 255.255.0.0
        gateway:                   # Gateway IP of Public Data Network. Not requried for DHCP.
        pvt_ip_addr: 192.168.0.3      # Fixed IP of Private Data Network
        roaming_ip: 192.168.0.6       # Applies to private data network
    storage:
      metadata_device:                # Device for /var/motr and possibly SWAP
        - /dev/sdb                    # Auto-populated by components.system.storage.multipath
      data_devices:                   # Data device/LUN from storage enclosure
